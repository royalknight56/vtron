...
export const enUS: AllText = {
  ...
  'search.in.current': 'Search in current folder',
  'search.result.count': '{count} results found',
  ...
  'volume.items.count': 'Contains',
  'volume.type.label': 'Type',
  'volume.disk.type': 'Local Disk',
  'preview': 'Preview',
