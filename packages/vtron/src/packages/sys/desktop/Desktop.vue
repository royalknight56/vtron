...
import DeskItem from '@packages/sys/desktop/components/DeskItem.vue';
import Taskbar from '@packages/sys/taskbar/Taskbar.vue';
import DesktopBackground from '@packages/sys/desktop/components/DesktopBackground.vue';
import { emitEvent } from '@packages/kernel';
import WindowGroup from '@packages/sys/window/WindowGroup.vue';
import ContextMenu from '@packages/sys/menu/ContextMenu.vue';
import NotificationGroup from '@packages/sys/notification/NotifyGroup.vue';
import MessageCenterPop from '@packages/sys/taskbar/popover/MessageCenterPop.vue';
