...
import { Dialog, Menu, i18n, BrowserWindow } from '@packages/sys';
...
@/packages/sys/window/BrowserWindow@/packages/sys/menu/Menu@/packages/kernel/event@/packages/sys/dialog/Dialog@/packages/sys/i18n