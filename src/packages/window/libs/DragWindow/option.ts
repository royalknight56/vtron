/*
 * @Author: Royal
 * @LastEditTime: 2022-04-27 16:38:12
 * @Description: 
 */
...
let defaultWindowOption = {
  ...
  transparent: false,
  center: false,
  buttons: [WindowButtonEnum.close, WindowButtonEnum.min, WindowButtonEnum.max],
  content: '',
}

type BaseOption = Merge<(typeof defaultWindowOption),{
  buttons?: WindowButtonEnum[],
  content?: DefineComponent<{}, {}, any> | string,
}>

let defaulBuiltInProps = {
  wid: 0,
  id: '0',
  zindex: 0,
  isVisible: true,
  ...
  isCreate: false,
  fullscreen: false,
  status: WindowStatusEnum.normal,
  callData: {
    callFrom: '',
  },
}
...
type BuiltinPorps = Merge<{},(typeof defaulBuiltInProps)>

interface WindowInfoTemp extends BuiltinPorps, BaseOption { }
